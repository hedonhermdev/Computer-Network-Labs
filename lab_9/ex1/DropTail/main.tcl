...
proc finish {} {
    ...
    exec xgraph qsize.tr -geometry 800x400 &
    exec nam out.nam &
    exit 0
}
...
# procedure to record queue size
proc record_queue {} {
    global qfile qmon
    ...
    puts $qfile "$now $qsize"

    $ns at [expr $now + $interval] "record_queue"
}
